		...
		<div class="container pt-3">
			<div class="row text-light">
				...
				<div class="col-md-3">
					<h6>About Us</h6>
					<ul class="list-unstyled">
						<li><a href="aboutUs.php">About E-Market</a></li>
					</ul>
				</div>
				<div class="col-md-3">
					<h6>Developpers Information</h6>
					<ul class="list-unstyled">
						<li class="text-primary">Rafsan Rahman</li>
						<li class="text-primary">Easinur Rashid Prantick</li>
						<li><a href="mailto:rafsan.aust40@gmail.com">rafsan.aust40@gmail.com</a></li>
					</ul>
				</div>
