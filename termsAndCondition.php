		...
		<div class="row m-5">
			<div class="col my-auto">
				<h1>Terms And Condition</h1>
					<p>If u want sell or buy products through <STRONG>E-Market</STRONG> you have to follow the terms and conditions. If you are okay with them then start <em>Buiseness</em> or <em>Shopping</em>.</p>
			</div>
			<div class="col">
