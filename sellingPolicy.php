	...
	<div class="container">
		<div class="row m-5">
			<div class="col my-auto">
				<h1>Selling Policy</h1>
					<p>This page will give you a brief idea how you can sell your products through this website. If u want to know more or have any confusion then <a href="contactUs.php">contact us</a>.</p>
			</div>
			<div class="col">
		...
		<div class="row m-5">
			...
			<div class="col my-auto">
				...
				<p>If you face any sort of inconvenience you can <a href="contactUs.php">contact us</a>. We will try to solve your problem as soon as possible.</p>
			</div>
		</div>
	</div>
